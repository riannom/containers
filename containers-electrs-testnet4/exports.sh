...
# PORTS (the wallet port is published on the host; see the port picker above)
export APP_CONTAINERS_ELECTRS_TESTNET4_PORT="$(containers_pick_port ELECTRUM_PORT 60041)"
