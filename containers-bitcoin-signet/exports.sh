...
export APP_CONTAINERS_BITCOIN_SIGNET_RPC_PORT="$(containers_pick_port RPC_PORT 38332)"
export APP_CONTAINERS_BITCOIN_SIGNET_P2P_PORT="$(containers_pick_port P2P_PORT 38333)"
